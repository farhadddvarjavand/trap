                ...
                <MDBContainer className={'fv-footerMenu fv-footerDisplayPage'}>
                    ...
                    <MDBRow className={' fv-footerDisplayPageBody'}>
                        ...
                        <MDBCol sm={2}  sm={2} className={"fv-DisplayPageLoginImageMobile"} >
                            <img src={this.state.AvatarSrc ? `${config.webapi}/images/user//${this.state.AvatarSrc}` : MobileLogo} onClick={()=>{
                    ...
                    <MDBContainer className={"fv-SearchHomePage fv-DisplayPage fv-ProfilePage"}>
                        ...
                        <MDBContainer className={'fv-footerMenu fv-footerDisplayPage'}>
                            ...
                            <MDBRow className={"fv-DisplayPageRotePathMobile"}>
                                <MDBCol>
                                    <a onClick={()=>window.location.replace("/") }> <p> صفحه اصلی </p> </a>
                ...
                <MDBRow className={"fv-ProfilePageLeftBody"}>
                    ...
                    {this.state.onclickHandel ?
                        <MDBCol md={3} className={"fv-ProfilePageUserInfoBody fv-HideDesktopForMobile"}>
                            ...
                            <MDBRow className={"fv-ProfilePageUserInfoDetailsBody"}>
                                <MDBCol className={"fv-ProfilePageUserInfoDetailsBodyColumn"}>
                                    <NavLink exact to={'/MainProfilePages/ProfileMyReservation'} activeClassName={"fv-reservationActive"} ><p   onClick={()=>this.setState({onclickHandel:false})}><i className="fas fa-book" />رزرو های من</p></NavLink>
                                    <NavLink to={'/MainProfilePages/ProfileMyTransaction'} activeClassName={"fv-reservationActive"} > <p onClick={()=>this.setState({onclickHandel:false})} > <i className="fas fa-chart-bar" />تراکنش های من</p> </NavLink>
                                    ...
                                    {this.state.activeClassChevron ? '' :
                                        <div>
                                            <NavLink to={'/MainProfilePages/myAccommodation'} activeClassName={"fv-reservationActive"} ><p className={'fv-ProfilePageUserInfoDetailsOption'} onClick={()=>this.setState({onclickHandel:false})}>اقامت گاه های من</p></NavLink>
                                            <NavLink to={'/MainProfilePages/profileReservations'}  activeClassName={"fv-reservationActive"}><p className= 'fv-ProfilePageUserInfoDetailsOption' onClick={()=>this.setState({onclickHandel:false})}>رزرو های درخواستی</p></NavLink>
                                            <NavLink to={'/MainProfilePages/ProfilePageCommentsHandle'}  activeClassName={"fv-reservationActive"}> <p className={ 'fv-ProfilePageUserInfoDetailsOption'} onClick={()=>this.setState({onclickHandel:false})}> نظرات مهمان ها</p></NavLink>
                                            <NavLink to={'/MainProfilePages/ProfilePageCalendarHandle'}  activeClassName={"fv-reservationActive"}><p className={ 'fv-ProfilePageUserInfoDetailsOption'} onClick={()=>this.setState({onclickHandel:false})}>تقویم من</p></NavLink>
                                        </div>
                                    }
                    ...
                    <MDBCol md={3} className={"fv-ProfilePageUserInfoBody fv-hideMobileForDesktop"}>
                        ...
                        <MDBRow className={"fv-ProfilePageUserInfoDetailsBody"}>
                            <MDBCol className={"fv-ProfilePageUserInfoDetailsBodyColumn"}>
                                <NavLink exact to={'/MainProfilePages/ProfileMyReservation'} activeClassName={"fv-reservationActive"} ><p   ><i className="fas fa-book" />رزرو های من</p></NavLink>
                                <NavLink to={'/MainProfilePages/ProfileMyTransaction'} activeClassName={"fv-reservationActive"} > <p > <i className="fas fa-chart-bar" />تراکنش های من</p> </NavLink>
                                <MDBRow className={"fv-ProfilePageFacilitiesMobile"}>
                                    <MDBCol md={8} sm={8}>
                                        <a onClick={()=>this.setState({activeClassChevron: !this.state.activeClassChevron})}><i className="fa fa-file-invoice" />امکانات میزبان</a>
                                    </MDBCol>
                                ...
                                {this.state.activeClassChevron ? '' :
                                    <div>
                                        <NavLink to={'/MainProfilePages/myAccommodation'} activeClassName={"fv-reservationActive"} ><p className={'fv-ProfilePageUserInfoDetailsOption'}>اقامت گاه های من</p></NavLink>
                                        <NavLink to={'/MainProfilePages/profileReservations'}  activeClassName={"fv-reservationActive"}><p className= 'fv-ProfilePageUserInfoDetailsOption'>رزرو های درخواستی</p></NavLink>
                                        <NavLink to={'/MainProfilePages/ProfilePageCommentsHandle'}  activeClassName={"fv-reservationActive"}> <p className={'fv-ProfilePageUserInfoDetailsOption'}> نظرات مهمان ها</p></NavLink>
                                        <NavLink to={'/MainProfilePages/ProfilePageCalendarHandle'}  activeClassName={"fv-reservationActive"}><p className={ 'fv-ProfilePageUserInfoDetailsOption'}>تقویم من</p></NavLink>
                                    </div>
                                }
                               ...
                               }}><p><i className="fas fa-home" />صفحه اصلی</p></a>
                            </MDBCol>
                        </MDBRow>
                    </MDBCol>
